...
export function HeroSection() {
  return (
    <section className="relative flex h-screen w-full flex-col items-start justify-center px-16 md:px-48 overflow-hidden">
      ...
      <div className="relative flex flex-col items-start gap-6 max-w-min">
        <h1 className="text-left text-xl md:text-3xl font-medium uppercase whitespace-nowrap">
          Ploycheeze
        </h1>
